---
title: "Chloramine and PFAS in Australian Water"
description: "Chloramine and PFAS need specific filtration — standard carbon won't cut it. What they are, where they show up in Australian water, and what removes them."
relatedLinks:
...
faq:
  - q: "Can a standard carbon filter remove chloramine?"
    a: "Not reliably at household flow rates. Standard GAC reduces some chloramine but cannot keep up with a shower. You need catalytic carbon, which is specifically processed for chloramine. Any cartridge marketed for chloramine should say 'catalytic carbon' — if it just says 'activated carbon' or 'GAC', it is not the right product."
...
A three-stage Big Blue setup typically runs: sediment pre-filter → catalytic carbon → carbon block polish. Browse the [whole-house category](/water-filters/whole-house/) for systems in this configuration.
...
For most households with PFAS concerns, the right setup is: a whole-house carbon-block stage for general use, plus an [RO system](/water-filters/reverse-osmosis/) at the kitchen tap for drinking water.
